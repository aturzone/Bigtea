...
//! renderings. "Chaos supports `gpt-oss`" then means "byte-identical to what
...
use chaos_tokenizer::chat::{ChatFormat, Message};
...
#[test]
fn every_template_chaos_claims_matches_llamacpp_exactly() {
