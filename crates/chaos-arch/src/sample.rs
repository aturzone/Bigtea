...
//!
//! Until now Chaos took the argmax. That is a legitimate decoding strategy and
...
impl Sampler {
    ...
    fn sample_mirostat(&mut self) -> u32 {
        ...
        // Mirostat is a stochastic sampler by construction, and Chaos's
...
mod tests {
    ...
    fn mirostat_alone_is_not_greedy() {
        ...
        // Chaos's default temperature is 0 where llama.cpp's is 0.8. Twice
