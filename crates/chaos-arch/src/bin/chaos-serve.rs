//! An OpenAI-compatible HTTP endpoint, so a coding agent can drive Chaos.
//!
//! Usage: `chaos-serve <model.gguf> [--port 8080] [--cache GiB]`
//!
...
//! This is the single item that turns Chaos from something you benchmark into
