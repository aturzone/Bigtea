//! Which models Bigtea knows about, and how to fetch them.
//!
...
/// A model Bigtea can fetch by name.
#[derive(Debug, Clone, Copy)]
pub struct Entry {
...
/// Everything Bigtea can fetch by name.
///
...
impl Plan {
    ...
    /// "does the model fit" — Bigtea's entire design is for models that do not.
