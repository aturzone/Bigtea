---
topic: Where Chaos stands against llama.cpp on 2026-08-11 — speed is level, coverage is not
...
```
Qwen3-4B prefill    chaos 78.23 76.01 76.56 76.37   llama.cpp 68.73 77.51 69.89 65.35
Qwen3-4B generation chaos  6.11  5.56  5.83  6.12   llama.cpp  5.55  5.52  5.68  5.52
Qwen3-30B gen       chaos  3.92  2.71  3.26  2.97   llama.cpp  3.60  2.93  3.31  3.19
```

## What the raw rounds show that the medians do not

**Chaos's prefill is the more stable of the two.** Across four rounds it spans
...
**Generation is the reverse**: llama.cpp is tight (5.52–5.68, 2.9%) and Chaos
spans 5.56–6.12 (10%), which is the thread tuner still moving. Chaos's worst
generation round still beats llama.cpp's best.

**On the streaming model, run order dominates everything.** Chaos scored 3.92
...
Chaos is now 3.10. But llama.cpp measured back to back today runs **2.93–3.60
...
as one: llama.cpp *declares* 141 and nobody has diffed all of them; Chaos's 8
