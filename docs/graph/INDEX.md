...
- backlog/mvp-v1.md — v1 milestone plan (no new tickets), re-paced 2026-07-28 for solo+Claude Code: 8 serialized weeks (T0 alone in week 1 while the rig bills; midpoint re-pace check at week 4; sync-audit checkpoints ⏹), incl. T0-fails fallback path — links: ../research/mvp-scope.md, ../decisions/fork-vs-wrapper.md, wrapper-core.md
