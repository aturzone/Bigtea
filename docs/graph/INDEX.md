...
1. benchmarking-methodology — reproducible tokens/sec + TTFT + cache-hit-rate reporting
2. licensing — fork ktransformers (Apache-2.0) vs independent wrapper calling it as a backend
3. mvp-scope — realistic 4–6 week MVP for a small open-source team
