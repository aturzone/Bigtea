...
| CLI flags | **195 recognised — 165 implemented, 30 declined with a reason.** Generated from the parser by `build.rs`, so it cannot drift from what is accepted | **182** (counted, not estimated: `llamacpp-flag-audit.md`) |
