...
- **`bigtea-run -v` prints the derived hparams** (`attn_scale`, per-layer RoPE bases, windowed-layer list). Use it before theorising: a key read under the wrong name looks exactly like a key that was absent.
